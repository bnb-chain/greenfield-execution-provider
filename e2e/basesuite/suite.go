...
func ParseValidatorMnemonic(i int) string {
	return ParseMnemonicFromFile(fmt.Sprintf("/Users/wuzhenxing/Documents/development/github/greenfield-execution-provider/deployment/.local/greenfield/deployment/localup/.local/validator%d/info", i))
}
